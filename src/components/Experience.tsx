      ...
      <div className="os-window">
        ...
        <div className="p-6">
          <div className="space-y-4">
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 text-xs">
              {responsibilities.map((resp, index) => (
                <div 
                  key={index}
                  className="px-2 py-1 rounded-md bg-gradient-to-r from-gray-800/50 to-gray-900/50 hover:from-purple-500/20 hover:to-blue-500/20 transition-colors duration-300 text-center"
                >
                  {resp}
                </div>
              ))}
